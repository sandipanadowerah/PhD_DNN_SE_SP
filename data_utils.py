...
class UnetDataset(Dataset):
    ...
    def __init__(self, dirpath, array_filepath, feature_dim=257):
        ...
        self.stft_mask_dir = os.path.join(dirpath, 'ds_mask')
    ...
    def __getitem__(self, index):
        ...
        y_stft, s_stft, mask = self.get_data(self.data_files[index])
        
        sample = {'y_stft':y_stft, 's_stft': s_stft, 'mask': mask}
...
def collate_fn_speech_enhancement(batch):
    ...
    if isinstance(batch[0], collections.Mapping):
        ...
        return y_stft[0], s_stft[0], mask[0]
