...
def main(params):
    ...
    test_dataset = get_UnetDataset(test_dirpath, test_array_filepath)

    train_dataset = get_UnetDataset(train_dirpath, train_array_filepath)


    train_dataloader = DataLoader(train_dataset, batch_size=1, shuffle=True, collate_fn=collate_fn_speech_enhancement, drop_last=True, num_workers=8)

    test_dataloader = DataLoader(test_dataset, batch_size=1, shuffle=True, collate_fn=collate_fn_speech_enhancement, drop_last=True, num_workers=8)
    ...
    for epoch in range(1):
        for phase in ['train']:
            ...
            for i, data in enumerate(dataloader[phase]):
                ...
                pass#print(y_stft.shape, s_stft.shape, mask.shape)
